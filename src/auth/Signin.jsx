...
const Signin = () => {
  ...
  return (
    <section className='signup w-full h-screen bg-white'>
      <div className='lg:mx-14 sm:px-3 overflow-hidden flex flex-row justify-between '>
        <div className='registration lg:w-[40%] sm:w-full flex-col align-middle justify-center h-full lg:my-16'>
            <div className='logo'>
                <img 
                    src={logo} 
                    alt="MyMedicare"
            ...
            <div className="topText py-2">
                ...
                <p className="text-neutral-50 first-letter:capitalize">login to your account to continue exploring our services</p>
            </div>
